...
fn main() {
  ...
  world.put_ball(Vector3f::new(0.5, 0.4, 0.5), 0.05, Vector3f::new(5.0, -2.0, 1.0), 1.25, 1250, youngs_modulus, nu);
  world.put_ball(Vector3f::new(0.58, 0.6, 0.58), 0.1, Vector3f::new(3.0, 5.0, -3.0), 10.0, 10000, youngs_modulus, nu);
  world.put_ball(Vector3f::new(0.42, 0.6, 0.42), 0.05, Vector3f::new(-4.3, 1.5, 8.0), 1.25, 1250, youngs_modulus, nu);
